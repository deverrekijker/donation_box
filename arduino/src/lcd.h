...
uint8_t euro[8] = {0x3,0x4,0x1e,0x8,0x1e,0x8,0x7}; // Euro symbol for lcd

const char INIT_MESSAGE[LCD_X] = "MONEYBOX IS GO";
const char GENERAL_MESSAGE[LCD_X] = "Donations, woo!";
